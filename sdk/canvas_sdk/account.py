from canvas_sdk.account_calendar import AccountCalendar
from canvas_sdk.authentication_event import AuthenticationEvent
from canvas_sdk.authentication_provider import AuthenticationProvider
...
from canvas_sdk.enrollment_term import EnrollmentTerm
from canvas_sdk.exceptions import CanvasException, RequiredFieldMissing
...
from canvas_sdk.group import Group, GroupCategory
from canvas_sdk.login import Login
from canvas_sdk.outcome import OutcomeGroup, OutcomeLink
from canvas_sdk.outcome_import import OutcomeImport
from canvas_sdk.paginated_list import PaginatedList
from canvas_sdk.rubric import Rubric
from canvas_sdk.scope import Scope
from canvas_sdk.sis_import import SisImport
from canvas_sdk.user import User
from canvas_sdk.util import combine_kwargs, file_or_path, obj_or_id, obj_or_str
...
class Account(CanvasObject):
    ...
    def activate_role(self, role, **kwargs):
        ...
        :type role: :class:`canvas_sdk.account.Role` or int
        :rtype: :class:`canvas_sdk.account.Role`
        """
    ...
    def add_authentication_providers(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.authentication_provider.AuthenticationProvider`
        """
        response = self._requester.request(
            "POST",
    ...
    def close_notification_for_user(self, user, notification, **kwargs):
        ...
        :type notification: :class:`canvas_sdk.account.AccountNotification` or int
    ...
    def create_admin(self, user, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.account.Admin`
        """
        user_id = obj_or_id(user, "user", (User,))
    ...
    def create_enrollment_term(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.enrollment_term.EnrollmentTerm`
        """
        response = self._requester.request(
            "POST",
    ...
    def create_report(self, report_type, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.account.AccountReport`
        """
        response = self._requester.request(
            "POST",
    ...
    def create_sis_import(self, attachment, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.sis_import.SisImport`
        """
    ...
    def create_user_login(self, user, login, **kwargs):
        ...
        :type login: `dict`
        :rtype: :class:`canvas_sdk.login.Login`
        """
    ...
    def delete_grading_period(self, grading_period, **kwargs):
        ...
        :type grading_period: :class:`canvas_sdk.grading_period.GradingPeriod` or int
    ...
    def get_account_calendar(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.account_calendar.AccountCalendar`
        """
    ...
    def get_admins(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of :class:`canvas_sdk.account.Admin`
        """
    ...
    def get_all_account_calendars(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.account_calendar.AccountCalendar`
        """
        return PaginatedList(
            AccountCalendar,
            self._requester,
    ...
    def get_authentication_events(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
                :class:`canvas_sdk.authentication_event.AuthenticationEvent`
        """
        return PaginatedList(
            AuthenticationEvent,
            self._requester,
    ...
    def get_authentication_provider(self, authentication_provider, **kwargs):
        ...
        :type authentication_provider:
            :class:`canvas_sdk.authentication_provider.AuthenticationProvider` or int
    ...
    def get_authentication_providers(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.authentication_provider.AuthenticationProvider`
        """
        return PaginatedList(
            AuthenticationProvider,
            self._requester,
    ...
    def get_content_migration(self, content_migration, **kwargs):
        ...
        :type contnet_migration: int, str or :class:`canvas_sdk.content_migration.ContentMigration`
    ...
    def get_enrollment(self, enrollment, **kwargs):
        ...
        :type enrollment: :class:`canvas_sdk.enrollment.Enrollment` or int
    ...
    def get_enrollment_term(self, term, **kwargs):
        ...
        :type term: :class:`canvas_sdk.enrollment_term.EnrollmentTerm` or int
    ...
    def get_enrollment_terms(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.enrollment_term.EnrollmentTerm`
        """
        return PaginatedList(
            EnrollmentTerm,
            self._requester,
    ...
    def get_index_of_reports(self, report_type, **kwargs):
        ...
        :type report_type: str
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.account.AccountReport`
        """
        return PaginatedList(
            AccountReport,
            self._requester,
    ...
    def get_scopes(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of :class:`canvas_sdk.scope.Scope`
        """
        return PaginatedList(
            Scope,
            self._requester,
    ...
    def get_sis_import(self, sis_import, **kwargs):
        ...
        :type sis_import: int, str or :class:`canvas_sdk.sis_import.SisImport`
    ...
    def get_sis_imports(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.sis_import.SisImport`
        """
        return PaginatedList(
            SisImport,
            self._requester,
    ...
    def get_sis_imports_running(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList`
            of :class:`canvas_sdk.sis_import.SisImport`
        """
        return PaginatedList(
            SisImport,
            self._requester,
    ...
    def get_subaccounts(self, recursive=False, **kwargs):
        ...
        :type recursive: bool
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.account.Account`
        """
    ...
    def get_user_notifications(self, user, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.account.AccountNotification`
        """
        user_id = obj_or_id(user, "user", (User,))
    ...
    def show_account_auth_settings(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.account.SSOSettings`
        """
        response = self._requester.request(
            "GET",
