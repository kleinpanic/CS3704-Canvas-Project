...
class Page(CanvasObject):
    ...
    def get_revision_by_id(self, revision, **kwargs):
        ...
        :type revision: :class:`canvas_sdk.pagerevision.PageRevision` or int

        :returns: Contents of the page revision.
        :rtype: :class:`canvas_sdk.pagerevision.PageRevision`
        """
    ...
    def get_revisions(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.pagerevision.PageRevision`
        """
