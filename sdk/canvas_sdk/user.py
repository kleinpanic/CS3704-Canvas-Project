...
from canvas_sdk.avatar import Avatar
from canvas_sdk.calendar_event import CalendarEvent
from canvas_sdk.canvas_object import CanvasObject
from canvas_sdk.communication_channel import CommunicationChannel
...
from canvas_sdk.page_view import PageView
from canvas_sdk.paginated_list import PaginatedList
from canvas_sdk.pairing_code import PairingCode
from canvas_sdk.upload import FileOrPathLike, Uploader
from canvas_sdk.usage_rights import UsageRights
from canvas_sdk.util import combine_kwargs, obj_or_id, obj_or_str
...
class User(CanvasObject):
    ...
    def create_communication_channel(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.communication_channel.CommunicationChannel`
        """
        response = self._requester.request(
            "POST",
    ...
    def create_pairing_code(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.pairing_code.PairingCode`
        """
    ...
    def get_avatars(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.avatar.Avatar`
        """
        return PaginatedList(
            Avatar,
            self._requester,
    ...
    def get_closed_poll_sessions(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.poll_session.PollSession`
        """
        from canvas_sdk.poll_session import PollSession
    ...
    def get_communication_channels(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.communication_channel.CommunicationChannel`
        """
        return PaginatedList(
    ...
    def get_eportfolios(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.eportfolio.EPortfolio`
        """
    ...
    def get_page_views(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.course.PageView`
        """
        return PaginatedList(
            PageView,
            self._requester,
    ...
    def merge_into(self, destination_user, **kwargs):
        ...
        :type destination_user: :class:`canvas_sdk.user.User` or int
