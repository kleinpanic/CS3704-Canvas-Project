...
class DiscussionTopic(CanvasObject):
    ...
    def get_entries(self, ids, **kwargs):
        ...
        :type ids: :class:`canvas_sdk.discussion_topic.DiscussionEntry`, or list or tuple of int

        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.discussion_topic.DiscussionEntry`
        """
    ...
    def get_parent(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.group.Group` or :class:`canvas_sdk.course.Course`
        """
    ...
    def post_entry(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.discussion_topic.DiscussionEntry`
        """
        response = self._requester.request(
            "POST",
            "{}s/{}/discussion_topics/{}/entries".format(
