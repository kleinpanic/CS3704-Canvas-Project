...
from canvas_sdk.assignment import Assignment, AssignmentGroup
from canvas_sdk.blueprint import BlueprintSubscription
from canvas_sdk.canvas_object import CanvasObject
from canvas_sdk.collaboration import Collaboration
from canvas_sdk.content_export import ContentExport
from canvas_sdk.course_epub_export import CourseEpubExport
from canvas_sdk.course_event import CourseEvent
from canvas_sdk.custom_gradebook_columns import CustomGradebookColumn
from canvas_sdk.discussion_topic import DiscussionTopic
from canvas_sdk.exceptions import RequiredFieldMissing
from canvas_sdk.external_feed import ExternalFeed
from canvas_sdk.feature import Feature, FeatureFlag
from canvas_sdk.folder import Folder
from canvas_sdk.grade_change_log import GradeChangeEvent
from canvas_sdk.gradebook_history import (
    Day,
    Grader,
    SubmissionHistory,
    SubmissionVersion,
)
from canvas_sdk.grading_period import GradingPeriod
from canvas_sdk.grading_standard import GradingStandard
from canvas_sdk.license import License
from canvas_sdk.lti_resource_link import LTIResourceLink
from canvas_sdk.module import Module
from canvas_sdk.new_quiz import AccommodationResponse, NewQuiz
from canvas_sdk.outcome_import import OutcomeImport
from canvas_sdk.page import Page
from canvas_sdk.paginated_list import PaginatedList
from canvas_sdk.progress import Progress
from canvas_sdk.quiz import QuizExtension
from canvas_sdk.rubric import Rubric, RubricAssociation
from canvas_sdk.searchresult import SearchResult
from canvas_sdk.submission import GroupedSubmission, Submission
from canvas_sdk.tab import Tab
from canvas_sdk.todo import Todo
from canvas_sdk.upload import FileOrPathLike, Uploader
from canvas_sdk.usage_rights import UsageRights
from canvas_sdk.util import (
    combine_kwargs,
    file_or_path,
    is_multivalued,
    normalize_bool,
...
class Course(CanvasObject):
    ...
    def add_grading_standards(self, title, grading_scheme_entry, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.grading_standards.GradingStandard`
        """
    ...
    def create_assignment(self, assignment, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.assignment.Assignment`
        """
        from canvas_sdk.assignment import Assignment
    ...
    def create_assignment_group(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.assignment.AssignmentGroup`
        """
    ...
    def create_assignment_overrides(self, assignment_overrides, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.assignment.AssignmentOverride`
        """
        from canvas_sdk.assignment import AssignmentOverride
    ...
    def create_content_migration(self, migration_type, **kwargs):
        ...
        :type migration_type: str or :class:`canvas_sdk.content_migration.Migrator`

        :rtype: :class:`canvas_sdk.content_migration.ContentMigration`
        """
        from canvas_sdk.content_migration import ContentMigration, Migrator
    ...
    def create_course_section(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.course.Section`
        """

        from canvas_sdk.section import Section
    ...
    def create_custom_column(self, column, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.custom_gradebook_columns.CustomGradebookColumn`
        """
    ...
    def create_discussion_topic(self, attachment=None, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.discussion_topic.DiscussionTopic`
        """
    ...
    def create_epub_export(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.course_epub_export.CourseEpubExport`
        """
        response = self._requester.request(
            "POST",
    ...
    def create_external_feed(self, url, **kwargs):
        ...
        :type url: str
        :rtype: :class:`canvas_sdk.external_feed.ExternalFeed`
        """
        response = self._requester.request(
            "POST",
    ...
    def create_external_tool(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.external_tool.ExternalTool`
        """
        from canvas_sdk.external_tool import ExternalTool
    ...
    def create_group_category(self, name, **kwargs):
        ...
        :type name: str
        :rtype: :class:`canvas_sdk.group.GroupCategory`
        """
        from canvas_sdk.group import GroupCategory
    ...
    def create_late_policy(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.course.LatePolicy`
        """
    ...
    def create_module(self, module, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.module.Module`
        """
    ...
    def create_new_quiz(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.new_quiz.NewQuiz`
        """
    ...
    def create_page(self, wiki_page, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.page.Page`
        """
    ...
    def create_quiz(self, quiz, **kwargs):
        ...
        :type quiz: dict
        :rtype: :class:`canvas_sdk.quiz.Quiz`
        """
        from canvas_sdk.quiz import Quiz
    ...
    def create_rubric_association(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.rubric.RubricAssociation`
        """
        from canvas_sdk.rubric import RubricAssociation
    ...
    def delete_external_feed(self, feed, **kwargs):
        ...
        :type feed: :class:`canvas_sdk.external_feed.ExternalFeed` or int
    ...
    def edit_front_page(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.course.Course`
        """
        response = self._requester.request(
            "PUT",
    ...
    def export_content(self, export_type, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.content_export.ContentExport`
        """
    ...
    def get_all_outcome_links_in_context(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.outcome.OutcomeLink`
        """
        from canvas_sdk.outcome import OutcomeLink
    ...
    def get_assignment_group(self, assignment_group, **kwargs):
        ...
        :type assignment_group: :class:`canvas_sdk.assignment.AssignmentGroup` or int
    ...
    def get_assignment_groups(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.assignment.AssignmentGroup`
        """
        from canvas_sdk.assignment import AssignmentGroup
    ...
    def get_blueprint(self, template="default", **kwargs):
        ...
        :type template: int or :class:`canvas_sdk.blueprint.BlueprintTemplate`

        :rtype: :class:`canvas_sdk.blueprint.BlueprintTemplate`
        """
        from canvas_sdk.blueprint import BlueprintTemplate
    ...
    def get_collaborations(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.collaboration.Collaboration`
        """
        return PaginatedList(
            Collaboration,
            self._requester,
    ...
    def get_content_export(self, content_export, **kwargs):
        ...
        :type content_export: int or :class:`canvas_sdk.content_export.ContentExport`
    ...
    def get_content_exports(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.content_export.ContentExport`
        """
        return PaginatedList(
            ContentExport,
            self._requester,
    ...
    def get_content_migration(self, content_migration, **kwargs):
        ...
        :type content_migration: int, str or :class:`canvas_sdk.content_migration.ContentMigration`
    ...
    def get_content_migrations(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.content_migration.ContentMigration`
        """
        from canvas_sdk.content_migration import ContentMigration
    ...
    def get_course_level_student_summary_data(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.course.CourseStudentSummary`
        """
    ...
    def get_custom_columns(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.custom_gradebook_columns.CustomGradebookColumn`
        """
        return PaginatedList(
    ...
    def get_discussion_topic(self, topic, **kwargs):
        ...
        :type topic: :class:`canvas_sdk.discussion_topic.DiscussionTopic` or int
    ...
    def get_epub_export(self, epub, **kwargs):
        ...
        :type epub: int or :class:`canvas_sdk.course_epub_export.CourseEpubExport`
    ...
    def get_external_feeds(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.external_feed.ExternalFeed`
        """
        return PaginatedList(
            ExternalFeed,
            self._requester,
    ...
    def get_external_tool(self, tool, **kwargs):
        ...
        :type tool: :class:`canvas_sdk.external_tool.ExternalTool` or int
    ...
    def get_external_tools(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.external_tool.ExternalTool`
        """
        from canvas_sdk.external_tool import ExternalTool
    ...
    def get_feature_flag(self, feature, **kwargs):
        ...
        :type feature: :class:`canvas_sdk.feature.Feature` or str

        :rtype: :class:`canvas_sdk.feature.FeatureFlag`
        """
    ...
    def get_features(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.feature.Feature`
        """
        return PaginatedList(
            Feature,
            self._requester,
    ...
    def get_file(self, file, **kwargs):
        ...
        :type file: :class:`canvas_sdk.file.File` or int

        :rtype: :class:`canvas_sdk.file.File`
        """
        from canvas_sdk.file import File
    ...
    def get_folder(self, folder, **kwargs):
        ...
        :type folder: :class:`canvas_sdk.folder.Folder` or int
    ...
    def get_grade_change_events(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.grade_change_log.GradeChangeEvent`
        """
    ...
    def get_gradebook_history_dates(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.grading_history.Day`
        """
    ...
    def get_gradebook_history_details(self, date, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.gradebook_history.Grader`
        """
    ...
    def get_grading_period(self, grading_period, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.grading_period.GradingPeriod`
        """
    ...
    def get_grading_periods(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.grading_period.GradingPeriod`
        """
    ...
    def get_grading_standards(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.grading_standards.GradingStandard`
        """
        return PaginatedList(
            GradingStandard,
            self._requester,
    ...
    def get_group_categories(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.group.GroupCategory`
        """
        from canvas_sdk.group import GroupCategory
    ...
    def get_groups(self, **kwargs):
        ...
        """
        from canvas_sdk.group import Group
    ...
    def get_licenses(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.license.License`
        """
    ...
    def get_lti_resource_link(self, lti_resource_link, **kwargs):
        ...
        :type lti_resource_link: :class:`canvas_sdk.lti_resource_link.LTIResourceLink` or int
    ...
    def get_lti_resource_links(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.lti_resource_link.LTIResourceLink`
        """
    ...
    def get_migration_systems(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.content_migration.Migrator`
        """
        from canvas_sdk.content_migration import Migrator
    ...
    def get_module(self, module, **kwargs):
        ...
        :type module: :class:`canvas_sdk.module.Module` or int
    ...
    def get_modules(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.module.Module`
        """
        return PaginatedList(
            Module,
            self._requester,
    ...
    def get_new_quiz(self, assignment, **kwargs):
        ...
        :type assignment: :class:`canvas_sdk.assignment.Assignment`
            or :class:`canvas_sdk.new_quiz.NewQuiz` or int
    ...
    def get_new_quizzes(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList`
            of :class:`canvas_sdk.new_quiz.NewQuiz`
        """
        endpoint = "courses/{}/quizzes".format(self.id)
        return PaginatedList(
            NewQuiz,
    ...
    def get_outcome_group(self, group, **kwargs):
        ...
        :type group: :class:`canvas_sdk.outcome.OutcomeGroup` or int

        :returns: An outcome group object.
        :rtype: :class:`canvas_sdk.outcome.OutcomeGroup`
        """
        from canvas_sdk.outcome import OutcomeGroup
    ...
    def get_outcome_groups_in_context(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.outcome.OutcomeGroups`
        """
        from canvas_sdk.outcome import OutcomeGroup
    ...
    def get_outcome_import_status(self, outcome_import, **kwargs):
        ...
        :type outcome_import: :class:`canvas_sdk.outcome_import.OutcomeImport`,
            int, or string: "latest"

        :rtype: :class:`canvas_sdk.outcome_import.OutcomeImport`
        """
    ...
    def get_outcome_results(self, **kwargs):
        ...
        :returns: :class:`canvas_sdk.paginated_list.PaginatedList`
            of :class:`canvas_sdk.outcome.OutcomeResult`
        """
        from canvas_sdk.outcome import OutcomeResult
    ...
    def get_quiz(self, quiz, **kwargs):
        ...
        :type quiz: :class:`canvas_sdk.quiz.Quiz` or int
    ...
    def get_quiz_overrides(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.quiz.QuizAssignmentOverrideSet`
        """
        from canvas_sdk.quiz import QuizAssignmentOverrideSet
    ...
    def get_rubric(self, rubric_id, **kwargs):
        ...
        :type rubric_id: int
        :rtype: :class:`canvas_sdk.rubric.Rubric`
        """
        response = self._requester.request(
            "GET",
    ...
    def get_rubrics(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.rubric.Rubric`
        """
        return PaginatedList(
            Rubric,
            self._requester,
    ...
    def get_section(self, section, **kwargs):
        ...
        :type section: :class:`canvas_sdk.section.Section` or int
    ...
    def get_sections(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.section.Section`
        """
        from canvas_sdk.section import Section
    ...
    def get_submission_history(self, date, grader_id, assignment_id, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.gradebook_history.SubmissionHistory`
        """
    ...
    def get_uncollated_submissions(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.gradebook_history.SubmissionVersion`
        """
    ...
    def list_blueprint_subscriptions(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.blueprint.BlueprintSubscription`
        """
    ...
    def query_audit_by_course(self, **kwargs):
        ...
        :rtype: list of :class:`canvas_sdk.course_event.CourseEvent`
        """
    ...
    def set_quiz_extensions(self, quiz_extensions, **kwargs):
        ...
        :rtype: list of :class:`canvas_sdk.quiz.QuizExtension`
    ...
    def set_usage_rights(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.usage_rights.UsageRights`
        """
    ...
    def smartsearch(self, q, **kwargs):
        ...
        :type kwargs: dict
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.searchresult.SearchResult`
        """
        kwargs["q"] = q
...
class CourseNickname(CanvasObject):
    ...
    def remove(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.course.CourseNickname`
        """
        response = self._requester.request(
            "DELETE",
