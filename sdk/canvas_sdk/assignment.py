...
from canvas_sdk.peer_review import PeerReview
from canvas_sdk.progress import Progress
from canvas_sdk.submission import Submission
from canvas_sdk.upload import FileOrPathLike, Uploader
from canvas_sdk.user import User, UserDisplay
from canvas_sdk.util import combine_kwargs, obj_or_id
...
class Assignment(CanvasObject):
    ...
    def get_gradeable_students(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.user.UserDisplay`
        """
        return PaginatedList(
            UserDisplay,
            self._requester,
    ...
    def get_override(self, override, **kwargs):
        ...
        :type override: :class:`canvas_sdk.assignment.AssignmentOverride` or int
    ...
    def get_peer_reviews(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.peer_review.PeerReview`
        """
        return PaginatedList(
            PeerReview,
            self._requester,
    ...
    def get_provisional_grades_status(self, student_id, **kwargs):
        ...
        :type student_id: :class:`canvas_sdk.user.User` or int
    ...
    def get_submission(self, user, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.submission.Submission`
        """
    ...
    def set_extensions(self, assignment_extensions, **kwargs):
        ...
        :rtype: list of :class:`canvas_sdk.assignment.AssignmentExtension`
    ...
    def show_provisonal_grades_for_student(self, anonymous_id, **kwargs):
        ...
        :type anonymous_id: :class:`canvas_sdk.user.User` or int
    ...
    def upload_to_submission(self, file: FileOrPathLike, user="self", **kwargs):
        ...
        :type user: :class:`canvas_sdk.user.User`, int, or str
