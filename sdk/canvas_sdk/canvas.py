...
from canvas_sdk.account import Account
from canvas_sdk.account_calendar import AccountCalendar
from canvas_sdk.appointment_group import AppointmentGroup
from canvas_sdk.calendar_event import CalendarEvent
from canvas_sdk.comm_message import CommMessage
from canvas_sdk.conversation import Conversation
from canvas_sdk.course import Course, CourseNickname
from canvas_sdk.course_epub_export import CourseEpubExport
from canvas_sdk.current_user import CurrentUser
from canvas_sdk.discussion_topic import DiscussionTopic
from canvas_sdk.eportfolio import EPortfolio
...
from canvas_sdk.jwt import JWT
from canvas_sdk.outcome import Outcome, OutcomeGroup
from canvas_sdk.paginated_list import PaginatedList
from canvas_sdk.planner import PlannerNote, PlannerOverride
from canvas_sdk.poll import Poll
from canvas_sdk.progress import Progress
from canvas_sdk.requester import Requester
from canvas_sdk.section import Section
from canvas_sdk.todo import Todo
from canvas_sdk.user import User
from canvas_sdk.util import combine_kwargs, get_institution_url, obj_or_id
...
class Canvas(object):
    ...
    def create_conversation(self, recipients, body, **kwargs):
        ...
        :type body: `str`
        :rtype: list of :class:`canvas_sdk.conversation.Conversation`
        """
    ...
    def create_planner_override(self, plannable_type, plannable_id, **kwargs):
        ...
        :type plannable_id: int or :class:`canvas_sdk.planner.PlannerOverride`
    ...
    def get_account(self, account, use_sis_id=False, **kwargs):
        ...
        :type account: int, str or :class:`canvas_sdk.account.Account`
    ...
    def get_appointment_group(self, appointment_group, **kwargs):
        ...
        :type appointment_group: :class:`canvas_sdk.appointment_group.AppointmentGroup` or int
    ...
    def get_appointment_groups(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.appointment_group.AppointmentGroup`
        """
        return PaginatedList(
            AppointmentGroup,
            self.__requester,
    ...
    def get_calendar_event(self, calendar_event, **kwargs):
        ...
        :type calendar_event: :class:`canvas_sdk.calendar_event.CalendarEvent` or int
    ...
    def get_calendar_events(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.calendar_event.CalendarEvent`
        """
        return PaginatedList(
            CalendarEvent,
            self.__requester,
    ...
    def get_comm_messages(self, user, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.comm_message.CommMessage`
    ...
    def get_conversation(self, conversation, **kwargs):
        ...
        :type conversation: :class:`canvas_sdk.conversation.Conversation` or int

        :rtype: :class:`canvas_sdk.conversation.Conversation`
        """
    ...
    def get_conversations(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of \
        :class:`canvas_sdk.conversation.Conversation`
        """
        return PaginatedList(
            Conversation,
            self.__requester,
    ...
    def get_course(self, course, use_sis_id=False, **kwargs):
        ...
        :type course: int, str or :class:`canvas_sdk.course.Course`
    ...
    def get_course_nickname(self, course, **kwargs):
        ...
        :type course: :class:`canvas_sdk.course.Course` or int
    ...
    def get_course_nicknames(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.course.CourseNickname`
        """
        return PaginatedList(
            CourseNickname,
            self.__requester,
    ...
    def get_current_user(self):
        ...
        :rtype: :class:`canvas_sdk.current_user.CurrentUser`
        """
    ...
    def get_eportfolio(self, eportfolio, **kwargs):
        ...
        :type eportfolio: :class: `canvas_sdk.eportfolio.EPortfolio` or int
    ...
    def get_epub_exports(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.course_epub_export.CourseEpubExport`
        """
    ...
    def get_group(self, group, use_sis_id=False, **kwargs):
        ...
        :type group: :class:`canvas_sdk.group.Group` or int
    ...
    def get_group_category(self, category, **kwargs):
        ...
        :type category: :class:`canvas_sdk.group.GroupCategory` or int
    ...
    def get_outcome(self, outcome, **kwargs):
        ...
        :type outcome: :class:`canvas_sdk.outcome.Outcome` or int
    ...
    def get_planner_note(self, planner_note, **kwargs):
        ...
        :type planner_note: int or :class:`canvas_sdk.planner.PlannerNote`
    ...
    def get_planner_notes(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.planner.PlannerNote`
        """
        return PaginatedList(
            PlannerNote,
            self.__requester,
    ...
    def get_planner_override(self, planner_override, **kwargs):
        ...
        :type planner_override: int or :class:`canvas_sdk.planner.PlannerOverride`
    ...
    def get_planner_overrides(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.planner.PlannerOverride`
        """
        return PaginatedList(
            PlannerOverride,
            self.__requester,
    ...
    def get_progress(self, progress, **kwargs):
        ...
        :type progress: int, str or :class:`canvas_sdk.progress.Progress`
    ...
    def refresh_jwt(self, jwt, **kwargs):
        ...
        :type jwt: str or :class:`canvas_sdk.jwt.JWT`
        :rtype: :class:`canvas_sdk.jwt.JWT`
        """
