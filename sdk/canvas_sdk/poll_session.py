...
from canvas_sdk.poll_submission import PollSubmission
...
class PollSession(CanvasObject):
    ...
    def close(self, **kwargs):
        ...
        :returns: :class:`canvas_sdk.poll_session.PollSession`
        """
    ...
    def get_submission(self, poll_submission, **kwargs):
        ...
        :type poll_submission: int or :class:`canvas_sdk.poll_submission.PollSubmission`
