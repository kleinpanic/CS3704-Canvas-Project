...
class ContentMigration(CanvasObject):
    ...
    def get_migration_issue(self, migration_issue, **kwargs):
        ...
        :type migration_issue: int, str or :class:`canvas_sdk.content_migration.ContentMigration`

        :rtype: :class:`canvas_sdk.content_migration.MigrationIssue`
        """
    ...
    def get_parent(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.group.Account`,
            or :class:`canvas_sdk.course.Course`,
            or :class:`canvas_sdk.course.Group`,
            or :class:`canvas_sdk.course.User`
        """
    ...
    def get_selective_data(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.content_migration.ContentMigrationSelectionNode`
        """
        from canvas_sdk.content_migration import ContentMigrationSelectionNode
