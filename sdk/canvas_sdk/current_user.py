from canvas_sdk.bookmark import Bookmark
from canvas_sdk.course import Course
from canvas_sdk.favorite import Favorite
...
class CurrentUser(User):
    ...
    def add_favorite_course(self, course, use_sis_id=False, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.favorite.Favorite`
        """
        if use_sis_id:
            course_id = course
    ...
    def create_bookmark(self, name, url, **kwargs):
        ...
        :type url: `str`
        :rtype: :class:`canvas_sdk.bookmark.Bookmark`
        """
        from canvas_sdk.bookmark import Bookmark
    ...
    def get_bookmark(self, bookmark, **kwargs):
        ...
        :type bookmark: :class:`canvas_sdk.bookmark.Bookmark` or int
    ...
    def get_bookmarks(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.bookmark.Bookmark`
        """
