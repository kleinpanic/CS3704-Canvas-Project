...
from canvas_sdk.util import combine_kwargs, is_multivalued
...
class CustomGradebookColumn(CanvasObject):
    ...
    def get_column_entries(self, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.paginated_list.PaginatedList` of
            :class:`canvas_sdk.custom_gradebook_columns.ColumnData`
        """
...
class ColumnData(CanvasObject):
    ...
    def update_column_data(self, column_data, **kwargs):
        ...
        :rtype: :class:`canvas_sdk.custom_gradebook_columns.ColumnData`
        """
