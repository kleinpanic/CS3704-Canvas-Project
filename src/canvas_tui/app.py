...
class CanvasTUI(App):
    ...
    def refresh_data(self, silent: bool = False) -> None:
        ...
        def worker() -> None:
            try:
                # Stage 1: fast core hydration (courses/planner/announcements)
                ...
                self.items = items  # Temporary assignment used by _prefetch_submissions
                ...
                # Stage 2: heavy hydration deferred so first paint stays fast.
    ...
    def _hydrate_grades_async(self, course_ids: list[int], *, seq: int, silent: bool) -> None:
        """Fetch grade data in a second phase to keep startup snappy."""
