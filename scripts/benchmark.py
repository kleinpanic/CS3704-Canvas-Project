...
# ── Model Loading ─────────────────────────────────────────────────────────────
def load_model(adapter_path: str | None, base_model: str = "google/gemma-2b-it"):
...
def parse_args():
    ...
    p.add_argument("--base-model", default="google/gemma-2b-it",
                   help="Base model ID (default: google/gemma-2b-it)")
