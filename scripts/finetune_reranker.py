...
Requirements:
    ...
    - Gemma 2B model on HuggingFace (nvidia/Llama-3.1-8B-Instruct-FP4)
"""
...
MODEL_NAME = "nvidia/Llama-3.1-8B-Instruct-FP4"  # Gemma 2B — 8B needs ~16GB VRAM; 2B at 4-bit fits on L4/RTX4000
