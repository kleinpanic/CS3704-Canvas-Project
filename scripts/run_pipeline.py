...
Usage:
    python3 scripts/run_pipeline.py --data data/rerank_train.jsonl --output output/pipeline

On Spark (via tmux):
    tmux new -s pipeline -d
    tmux send-keys 'cd ./gemma2b-reranker && python3 scripts/run_pipeline.py --data data/rerank_train.jsonl --output output/pipeline' Enter
"""
...
def main():
    ...
    p.add_argument("--output", default="./output/pipeline", help="Output base dir")
